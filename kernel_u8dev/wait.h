...
void queue_insert_tpri(QUEUE *p_queue, TCB *p_tcb)
{
	QUEUE	*p_entry;
...
void wait_dequeue_wobj(TCB *p_tcb)
{
...
void wobj_change_priority(WOBJCB *p_wobjcb, TCB *p_tcb)
{
