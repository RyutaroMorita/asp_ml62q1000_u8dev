 ...
 */
#pragma INLINE current_iipm
uint16_t current_iipm(void)
{
	return dummy_iipm;
}
 ...
 */
#pragma INLINE set_iipm
void set_iipm(uint16_t iipm)
{
	iipm = dummy_iipm;
}
...
{																		\
	(p_tcb)->tskctxb.sp = (void *)((char *)((p_tcb)->p_tinib->stk)		\
										+ (p_tcb)->p_tinib->stksz);		\
	(p_tcb)->tskctxb.pc = (void __far *) start_r;						\
}
 ...
 *  現）の参照
 */
#pragma INLINE exc_get_iipm
uint16_t exc_get_iipm(void *p_excinf)
{
