...
void queue_initialize(QUEUE *p_queue)
{
...
void queue_insert_prev(QUEUE *p_queue, QUEUE *p_entry)
{
...
void queue_insert_next(QUEUE *p_queue, QUEUE *p_entry)
{
...
void queue_delete(QUEUE *p_entry)
{
...
QUEUE *queue_delete_next(QUEUE *p_queue)
{
	QUEUE	*p_entry;
...
bool_t queue_empty(QUEUE *p_queue)
{
