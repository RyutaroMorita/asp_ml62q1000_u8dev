...
uint8_t sil_reb_mem(const uint8_t *mem)
{
	uint8_t	data;
...
uint16_t sil_reh_mem(const uint16_t *mem)
{
	uint16_t	data;
...
uint16_t sil_reh_lem(const uint16_t *mem)
{
	uint16_t	data;
...
void sil_wrh_lem(uint16_t *mem, uint16_t data)
{
...
uint16_t sil_reh_bem(const uint16_t *mem)
{
	uint16_t	data;
...
uint32_t sil_rew_mem(const uint32_t *mem)
{
	uint32_t	data;
...
uint32_t sil_rew_lem(const uint32_t *mem)
{
	uint32_t	data;
...
void sil_wrw_lem(uint32_t *mem, uint32_t data)
{
...
uint32_t sil_rew_bem(const uint32_t *mem)
{
	uint32_t	data;
